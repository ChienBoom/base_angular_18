export class StringUtils {
  ...
  static compareIgnoreCase(input1: string, input2: string): boolean {
    return (
      StringUtils.lowerAndTrim(input1) === StringUtils.lowerAndTrim(input2)
    );
  }

  static toLowerCaseNonAccentVietnamese = (str: string): string => {
    str = str.toLowerCase();
  ...
  static toNonAccentVietnamese = (str: string): string => {
